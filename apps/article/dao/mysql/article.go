...
type Article struct {
	...
	User        mysql.User `gorm:"foreignkey:UserID"`
}
...
func NewArticleModel(ctx context.Context) *ArticleModel {
	return &ArticleModel{AddContext(ctx)}
}

// 添加文章
func (am *ArticleModel) CreateArticle(article *Article) int {
...
// 查询单个文章的详细信息
func (am *ArticleModel) GetArticleByID(id int) (Article, int) {
	var article Article
...
// 根据关键字搜索文章
func (am *ArticleModel) GetArticlesByKeyWord(keyword string, pageSize int, pageNum int) ([]Article, int) {
	if len(keyword) == 0 {
...
// 查询某个用户发布的所有文章
func (am *ArticleModel) GetUserArticles(userid int) ([]Article, int) {
	var articles []Article
...
// 查询文章列表
func (am *ArticleModel) GetArticles(pageSize int, pageNum int) ([]Article, error) {
	var articles []Article
	if pageNum != -1 {
		pageNum = (pageNum - 1) * pageSize
	}
...
// 编辑文章
func (am *ArticleModel) UpdateArticle(id int, article *Article) int {
...
// 删除文章
func (am *ArticleModel) DeleteArticle(id int) int {
	var article Article
